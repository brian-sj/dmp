...
namespace MissionPlanner.Utilities
{
    public class LogAnalyzer
    {
        ...
        {
            if(false)//if (   Program.WindowsStoreApp)  // ÀÏ´Ü »©ÀÚ... 
            {
                DMP.Dialogs.CustomMessageBox.Show(Strings.Not_available_when_used_as_a_windows_store_app);
            ...
            //if (!File.Exists(runner))
            {
                ...
                DMP.Dialogs.CustomMessageBox.Show("Downloading LogAnalyzer");
                ...
                if (gotit)
                {
                    ...
                    DMP.Dialogs.CustomMessageBox.Show("Extracting zip file");
                    // extract zip
                ...
                else
                {
                    if (!File.Exists(runner))
                    {
                        DMP.Dialogs.CustomMessageBox.Show("Failed to download LogAnalyzer");
                        return "";
                    }
                }
            ...
            try
            {
                ...
                DMP.Dialogs.CustomMessageBox.Show("Running LogAnalyzer");
            ...
            {
                DMP.Dialogs.CustomMessageBox.Show("Failed to start LogAnalyzer");
            }
