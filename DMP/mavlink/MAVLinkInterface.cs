...
namespace MissionPlanner.Mavlink
{
    public class MAVLinkInterface : MAVLink, IDisposable
    {
        ...
        /// </summary>
        DMP.Dialogs.ProgressReporterDialogue frmProgressReporter;
        ...
        public void Open(bool getparams, bool skipconnectedcheck = false)
        {
            ...
            frmProgressReporter = new DMP.Dialogs.ProgressReporterDialogue(10,"Start");
            frmProgressReporter.Show();
            /* 
             * { StartPosition = FormStartPosition.CenterScreen, Text = Strings.ConnectingMavlink };  
             */
...
4. Try a diffrent usb port\n\n" +
        ...
        public void getParamList()
        {
            ...
            frmProgressReporter = new DMP.Dialogs.ProgressReporterDialogue
            {
                ...
                //frmProgressReporter.
                Title  = Strings.GettingParams + " " + sysidcurrent
            };
        ...
        public bool doCommand(byte sysid, byte compid, MAV_CMD actionid, float p1, float p2, float p3, float p4, float p5, float p6, float p7, bool requireack = true, Action  uicallback = null)
        {
            giveComport = true;
            MAVLinkMessage buffer;
        ...
        /// <summary>
        /// MavProxy 가 무한루프 돌면서 5milli seconds 마다 요청한다.  data 에다가는 null 을 보낸다. 
        /// </summary>
            ...
            bool close = false)
        {
            ...
            else  /// 이경우는 5milliseconds 마다 공수표 날리는 것 
            {
                if (!close)
                ...
                ////   generatePacket함수는 readOnly 일경우는  다음의 MSG_ID 가 아니면 다 버린다..

                /*
                 * messageType == (byte) MAVLINK_MSG_ID.MISSION_REQUEST_LIST ||
                messageType == (byte)MAVLINK_MSG_ID.MISSION_REQUEST_PARTIAL_LIST ||
                messageType == (byte)MAVLINK_MSG_ID.MISSION_REQUEST ||
                messageType == (byte)MAVLINK_MSG_ID.PARAM_REQUEST_LIST ||
                messageType == (byte)MAVLINK_MSG_ID.PARAM_REQUEST_READ ||
            ...
            try
            {
                if (datin.Length > 5)
                {
                    ...
                    if (PrintToConsole)
                    {
                        ...
                        if (PrintToConsole)
                            Console.Write("DebugPacket :"+textoutput);
